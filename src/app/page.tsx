          ...
          {tools.map((tool) => (
            <motion.div key={tool.href} variants={itemVariants}>
              <Link href={tool.href}>
                ...
                >
                  <div
                    className={`mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br ${tool.gradient} mx-auto`}
                  >
                  ...
                  <div className="mt-4 flex items-center gap-1 text-sm font-medium text-primary mx-auto">
                    Get started
