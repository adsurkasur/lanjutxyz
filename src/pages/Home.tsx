...
const tools = [
  {
    ...
    description: "Generate single or bulk QR codes with optional logo overlay. Download as PNG or ZIP.",
    icon: QrCode,
    href: "/qr",
  ...
  {
    title: "URL Shortener",
    description: "Create branded short links with custom slugs. Track clicks and manage all your links.",
    icon: LinkIcon,
    href: "/short",
    gradient: "from-primary/10 to-primary/5",
  },
          ...
          {tools.map((tool) => (
            <motion.div key={tool.href} variants={item}>
              <Link to={tool.href}>
                ...
                >
                  <div className={`mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br ${tool.gradient}`}>
